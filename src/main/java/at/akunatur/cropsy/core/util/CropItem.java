...
public class CropItem extends Item {
	...
	public CropItem(Block blockIn, Item.Properties builder) {
		super(builder);
		this.block = blockIn;
	...
	protected BlockState getStateForPlacement(BlockItemUseContext context) {
		BlockState blockstate = this.getPlacedBlock().getStateForPlacement(context);
	...
	private static <T extends Comparable<T>> BlockState func_219988_a(BlockState p_219988_0_, Property<T> p_219988_1_,
			String p_219988_2_) {
	...
	protected boolean canPlace(BlockItemUseContext p_195944_1_, BlockState p_195944_2_) {
		...
		return (!this.checkPosition() || p_195944_2_.isValidPosition(p_195944_1_.getWorld(), p_195944_1_.getPos()))
				&& p_195944_1_.getWorld().placedBlockCollides(p_195944_2_, p_195944_1_.getPos(), iselectioncontext);
	}
	...
	public Block getPlacedBlock() {
		return Cropfunktion.chooseBlock(this.getBlockRaw() == null ? null : this.getBlockRaw().delegate.get());
	}
